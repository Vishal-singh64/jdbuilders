        ...
        <div class="container">
            ...
            <div class="row about-us-row mt-4" data-aos="fade-right">
                <div class="col-md-7 order-md-1 order-2 p-4 about-us-text">
                    ...
                    Our goal is to build homes and commercial spaces that enhance the quality of life for our clients 
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4">
          ...
          <div class="card profile-card mt-5" data-aos="fade-right">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">JD Builders, led by 26-year-old Mr. Jatinder Kumar,a structural engineering master's degree holder with a background as a dedicated UPSC aspirant, delivers innovative, high-quality projects with technical expertise and disciplined strategic thinking.</p>
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4" >
          <div class="card profile-card mt-5" data-aos="fade-right">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">JD Builders is led by Mr. Deepak Kumar, a 29-year-old structural engineering master's degree holder with 5 years of experience in construction valuation and project management, ensuring flawless execution, customer satisfaction with operational expertise.</p>
              <div class="social-icons">
                <a href="#" class="me-2"><i class="fab fa-facebook-f"></i></a>
                <a href="#" class="me-2"><i class="fab fa-twitter"></i></a>
                <a href="#"><i class="fab fa-instagram"></i></a>
    ...
    <h2 class="text-center">Our Services</h2>
        <div class="row">
            <div class="col-12 col-md-12 col-lg-3 mb-4">
                <!-- -------------------------card Body -------------------- -->
                    <div class="container">
                        <div class="card service-card service-card-1 mt-5" data-aos="fade-right">
                            ...
                            <div class="service-card-overlay">
                                <div class="overlay-content">
                                    <h3>Residential Construction</h3>
                                    We specialize in building high-quality residential properties, 
                                    including apartments, villas, and townhouses. Our designs are focused on maximizing 
                                    space, comfort, and functionality, while also ensuring aesthetic appeal.
                                </div>
                            </div>
                        </div>
                    </div>
