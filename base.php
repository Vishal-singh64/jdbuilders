...
<script>
    ...
    window.addEventListener('scroll', function() {
        ...
        if (window.scrollY > 50) { // Adjust the value to determine when the navbar should change
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    animateCount(projectsCount, 0, 97, 3000); // 0 to 97 in 0.3 seconds
    animateCount(employeesCount, 0, 450, 3000); // 0 to 450 in 0.3 seconds
